...
static enum io_method   io2 = IO_METHOD_MMAP;
static int              fd2 = -1;
struct buffer          *buffers2;
static unsigned int     n_buffers2;
static int              out_buf2;
static int              force_format2;
static int              frame_count2 = 125;
...
int main(){
    ...
    int ret;
    int ret2;
    char * nama_device = "/dev/video1";
    char * nama_device2 = "/dev/video2";
