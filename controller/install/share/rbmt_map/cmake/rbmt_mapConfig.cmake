...
if("FALSE" STREQUAL "TRUE")
  set(rbmt_map_SOURCE_PREFIX /home/lintang-sutawika/krai/trui-bot-prj/controller/src/rbmt_map)
  set(rbmt_map_DEVEL_PREFIX /home/lintang-sutawika/krai/trui-bot-prj/controller/devel)
  set(rbmt_map_INSTALL_PREFIX "")
  set(rbmt_map_PREFIX ${rbmt_map_DEVEL_PREFIX})
else()
  set(rbmt_map_SOURCE_PREFIX "")
  set(rbmt_map_DEVEL_PREFIX "")
  set(rbmt_map_INSTALL_PREFIX /home/lintang-sutawika/krai/trui-bot-prj/controller/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rbmt_map' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lintang-sutawika/krai/trui-bot-prj/controller/install/${idir}'.  Ask the maintainer 'tor <tor@todo.todo>' to fix it.")
    endif()
