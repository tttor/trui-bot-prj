...
if("FALSE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/lintang-sutawika/krai/trui-bot-prj/controller/src/map_server)
  set(map_server_DEVEL_PREFIX /home/lintang-sutawika/krai/trui-bot-prj/controller/devel)
  ...
  set(map_server_INSTALL_PREFIX /home/lintang-sutawika/krai/trui-bot-prj/controller/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <fergs@unboundedrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lintang-sutawika/krai/trui-bot-prj/controller/install/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <fergs@unboundedrobotics.com>' to fix it.")
    endif()
