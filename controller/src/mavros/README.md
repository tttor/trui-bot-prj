...
@tttor:
> clone from https://github.com/mavlink/mavros.git on Sep 27, 2014.
> we abuse the setpoint_velocity plugin for sending speed commands for three motors
> for that, we customized:
>> set_position_target_local_ned(.) @file:<...>/mavros/src/plugins/setpoint_velocity.cpp
>> mavlink_msg_set_position_target_local_ned_pack_chan(.) @file: <...>/mavros/include/mavros/setpoint_mixin.h
